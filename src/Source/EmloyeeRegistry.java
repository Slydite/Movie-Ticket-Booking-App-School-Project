 ...
 * @author gargp
 */
public class EmloyeeRegistry extends javax.swing.JFrame {

    /**
     * Creates new form EmloyeeRegistry
     */
    public EmloyeeRegistry() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        master = new javax.swing.JPasswordField();
        ...
        jLabel5.setText("Master Passphrase:");

        master.setText("123456789");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(master, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int advn = (int) Math.random();
        String sql1;
        sql1="select * from employee where AdvantageCode="+advn;
        Statement st=con.createStatement();
        ResultSet rs=st.executeQuery(sql1);
        if(!rs.next())
            advn = advn;
        else{
            advn = (int) Math.random();
        }
        if(master.getText().equals("master")){
            if(pass.equals(pass1)){
            try {
                    String sql;
                    sql = "insert into employee(EmpUsername,EmpPassword,AdvantageCode) values('"+ user +"','"+pass+"',"+advn+")";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmloyeeRegistry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JPasswordField master;
